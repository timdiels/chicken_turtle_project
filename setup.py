...
setup(
    **{   'author': 'Tim Diels',
    ...
    'long_description': 'Python 3 project development tools. Looks like a turtle, tastes like\n'
                        ...
                        '----------\n'
                        '\n'
                        'Your project should adhere to the following minimal structure (can be\n'
                        'created with ``ct-mkproject``):\n'
                        '\n'
                        '::\n'
                        '\n'
                        '    $project_name\n'
                        ...
                        '``ct-mksetup``. Package data can be added by adding a ``data`` directory\n'
                        'without an ``__init__.py`` to the package in the ``$project_name`` tree.\n'
                        '\n'
