...
#: Newly created `project.py`s must match this template
project_py= """
project = dict(
    name='{name}',  # PyPI name. `name.replace('-', '_')` will used in all other places instead
...
dev_requirements_in = ['sphinx']

#: test_requirements.in must contain these dependencies, in this order
test_requirements_in = ['pytest', 'pytest-env', 'pytest-testmon', 'pytest-cov', 'coverage-pth']
...
coveragerc_overwrite = {'run': {'omit': '{pkg_name}/test/*'}} #TODO _IniFileReq doesn't do any format yet
